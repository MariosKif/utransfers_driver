...
import 'package:utransfers_driver/assistants/assistant_methods.dart';
                ...
                children: [
                  ElevatedButton(
                    ...
                    onPressed: ()
                    {
                      ...
                      {
                        Fluttertoast.showToast(msg: "Ride Request has been Cancelled Successfully. Restart the app now");
                      });
